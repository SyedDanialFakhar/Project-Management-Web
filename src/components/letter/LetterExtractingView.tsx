...
export function LetterExtractingView() {
  return (
      ...
      <div className="text-center space-y-6 px-8">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Extracting patient info and generating letter...
          </p>
        </div>
        <div className="flex items-center justify-center gap-1.5 flex-wrap">
          {['Patient Info', 'Medications', 'PMHx', 'Allergies', 'Social History', 'Letter Body'].map((item, i) => (
            <span
              key={item}
