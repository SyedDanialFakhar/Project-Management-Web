...
export function DocumentActions({ originalText, fixedText, fileName, isFixing, hasFixed, onFix, onReset }: DocumentActionsProps) {
      ...
      if (downloadFormat === 'txt') {
        ...
        const doc = new Document({
          sections: [{
            properties: {},
            children: [
              new Paragraph({ text: baseName, heading: HeadingLevel.TITLE, spacing: { after: 400 } }),
              ...paragraphs,
            ],
          }],
        });
        ...
        win.document.write(`
          <html>
            <head>
              ...
              <style>
                body { font-family: Calibri, sans-serif; font-size: 14px; line-height: 1.8; padding: 60px; max-width: 800px; margin: 0 auto; color: #1a1a1a; }
  ...
  return (
    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pt-5 border-t border-border/40">
      ...
      <div className="flex items-center gap-2">
        <Button onClick={onFix} disabled={!originalText || isFixing} className="gap-2">
          {isFixing ? (
            <>
